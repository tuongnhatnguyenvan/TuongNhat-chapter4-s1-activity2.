...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !empty($_POST['username']) && !empty($_POST['message'])) :
    ...
    // $db->query("INSERT INTO posts (name, message) VALUES ('Rady', 'Hello !');");
...
<div class="card">
    <div class="card-header">
        <span>
            <?php // TO DO: display the value of username for this post 
            echo $post['name'];
            ?>
        </span>
    </div>
    <div class="card-body">
        <p class="card-text">
            <?php // TO DO: display the message for this post 
            echo $post['message'];
            ?>
        </p>
    </div>
